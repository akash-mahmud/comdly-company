...
import Card, { CardHeader, CardLabel, CardTitle, CardSubTitle, CardBody, CardFooter, CardFooterLeft, CardFooterRight, CardActions } from '@/components/bootstrap/Card';
...
import { getUnitType, getLabel, getViews, CalendarTodayButton, CalendarViewModeButtons } from '@/components/extras/calendarHelper';
...
type TTabs = 'Account Details' | 'Address' | 'My Wallet' | 'Company';
interface ITabs {
	[key: string]: TTabs;
}
								...
								<div className='row g-3'>
									...
									<div className='col-12'>
										<Button
											...
											color='success'
											className='w-100 p-3'
											isLight={TABS.COMPANY !== activeTab}
